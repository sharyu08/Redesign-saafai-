export default function BulkActionsBar({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-[hsl(var(--bg-light-gray))] border border-[hsl(var(--border))] rounded-2xl p-4 mb-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg border border-[hsl(var(--border))] bg-white text-[hsl(var(--text-body))] text-sm font-medium hover:bg-[hsl(var(--bg-light-gray))] transition-colors flex items-center"
        >
          <svg className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
          </svg>
