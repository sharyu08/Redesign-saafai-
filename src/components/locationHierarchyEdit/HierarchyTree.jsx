    ...
    return (
        <div className="bg-white rounded-[32px] border border-slate-100 p-8 shadow-sm h-full">
            <div className="flex items-center gap-4 mb-10">
                <div className="h-10 w-10 rounded-xl bg-[hsl(var(--lavender-200))] flex items-center justify-center">
                    <GitBranch size={20} className="text-black" strokeWidth={2.5} />
                </div>
            ...
            <div className="flex flex-col items-center py-4">
                ...
                <div className="relative">
                    <div className="rounded-2xl border-2 border-slate-200 bg-white px-6 py-4 shadow-md text-black font-black text-[11px] uppercase tracking-wider z-10 relative">
                    ...
                    {[
                        ...
                        <div key={node.id} className="relative">
                            ...
                            <div className={`rounded-2xl px-5 py-3 shadow-sm border font-black text-[10px] uppercase tracking-wider transition-all ${node.active
                                            ? "bg-[hsl(var(--lavender-200))] border-[hsl(var(--lavender-200))] text-black"
                                            : "bg-[hsl(var(--lavender-100))] border-slate-100 text-slate-400"
                                        }`}>
