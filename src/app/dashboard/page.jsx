        ...
        {locations.slice(0, 3).map((loc, i) => (
          ...
          >
            <div className="flex items-center gap-2">
              <div className={`h-6 w-6 rounded-full flex items-center justify-center text-white text-xs font-medium ${
                i === 0 ? 'bg-[#2DB7C4] dark:bg-gradient-to-br dark:from-cyan-500 dark:to-blue-600' :
