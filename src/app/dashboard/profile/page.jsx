        ...
        <div className="min-h-screen bg-white dark:bg-background pb-12 transition-colors duration-300">
            <div className="max-w-[1200px] mx-auto p-4 md:p-8 space-y-6">
                ...
                <div className="bg-white border border-slate-100 rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-[hsl(var(--lavender-100))] rounded-full -mr-32 -mt-32 opacity-50" />

                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                        <div className="relative group">
                            <div className="h-32 w-32 rounded-[40px] bg-gradient-to-br from-[hsl(var(--primary-accent))] to-[hsl(var(--primary))] flex items-center justify-center border-4 border-white shadow-xl">
                                <span className="text-4xl font-black text-white uppercase">{userData.name.charAt(0)}</span>
                            </div>
                            <button className="absolute bottom-0 right-0 p-2 bg-white rounded-xl shadow-lg border border-slate-100 text-[hsl(var(--primary))] hover:scale-110 transition-transform">
                        ...
                        <div className="text-center md:text-left space-y-2 flex-1">
                            <div className="flex flex-col md:flex-row md:items-center gap-3">
                                <h1 className="text-3xl font-black text-[hsl(var(--primary))] tracking-tight">{userData.name}</h1>
                                <StatusBadge status={userData.status} />
                            </div>
                            <p className="text-sm font-black text-[hsl(var(--primary-accent))] uppercase tracking-[0.2em]">{userData.role}</p>
                        ...
                        <Link
                            ...
                            className="btn-primary flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest active:scale-95"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1 bg-white border border-slate-100 rounded-[28px] p-6 shadow-sm">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                <div className="p-2.5 bg-white dark:bg-card rounded-xl text-[#58BECF] dark:text-primary-light border border-border"><Mail size={18} /></div>
                                <div>
                    ...
                    <div className="lg:col-span-2 bg-white border border-slate-100 rounded-[28px] p-6 shadow-sm flex flex-col items-center justify-center text-center space-y-4 min-h-[300px]">
                        <div className="h-20 w-20 rounded-full bg-[hsl(var(--lavender-200))] flex items-center justify-center">
                            <ShieldCheck size={32} className="text-[hsl(var(--primary-accent))]" />
                        </div>
                        <div>
                            <h4 className="font-black text-[hsl(var(--primary))] text-sm uppercase tracking-widest">Workspace Compliance</h4>
