...
import { ArrowLeft, ShieldCheck, Plus, Phone, Mail, Calendar } from "lucide-react";

export default function WashroomSupervisorsPage() {
                ...
                if (Array.isArray(data)) {
                    ...
                    if (washroomData) {
                        setWashroom({
                            ...
                            supervisor_assignments: washroomData.supervisor_assignments || []
                        });
                    }
                }
            } catch (error) {
                ...
                <div className="bg-white rounded-lg shadow-sm">
                    <div className="p-6">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-lg font-semibold text-gray-900">Assigned Supervisors</h2>
                        ...
                        {washroom.supervisor_assignments && washroom.supervisor_assignments.length > 0 ? (
                            <div className="space-y-4">
                                {washroom.supervisor_assignments.map((assignment) => (
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="font-medium text-gray-900">
                                                        {assignment.supervisor_user?.name || 'Unknown'}
                                                    </h3>
                                                    <div className="flex items-center gap-4 mt-1">
                                                        <div className="flex items-center gap-1 text-sm text-gray-600">
                                                            <Phone className="w-4 h-4" />
                                                            {assignment.supervisor_user?.phone || 'No phone'}
                                                        </div>
                                                        <div className="flex items-center gap-1 text-sm text-gray-600">
                                                            <Mail className="w-4 h-4" />
                                                            {assignment.supervisor_user?.email || 'No email'}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-600">No supervisors assigned to this washroom</p>
