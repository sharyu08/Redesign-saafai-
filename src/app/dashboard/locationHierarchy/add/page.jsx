...
export default function AddHierarchyPage() {
    return (
        <div className="min-h-screen bg-white dark:bg-background pb-12 transition-all duration-300 shadow-lg">
            <div className="max-w-[1600px] mx-auto p-4 md:p-8 flex flex-col gap-8">

                {/* 1. Header Section - Acts as a floating white command bar */}
                <div className="z-20 shadow-md rounded-2xl">
                    <AddHierarchyHeader />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white rounded-[32px] shadow-lg border border-slate-100 overflow-hidden">
                            <CreateHierarchyForm />
                        </div>
                    </div>
                    ...
                    <div className="relative h-full">
                        <div className="bg-white rounded-[32px] shadow-lg border border-slate-100 p-2 h-full">
                            <HierarchyTreePreview />
                        </div>
                    </div>
